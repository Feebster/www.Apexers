  ...
  const projects = [
    {
      ...
      tags: ['Oracle databases', 'Oracle Apex', 'Business Intelligence', 'Collaboration'],
      link: 'www.yollen.nl',
      featured: true,
    ...
    },
    {
      ...
      tags: ['AI productenhancement', 'WP Plugin', 'Woocommerce', 'E-commerce'],
      link: 'powerwiz.nl',
      featured: true,
    ...
    },
    {
      ...
      tags: ['Full-Stack Oracle Dev', 'API Integraties','NodeJS','Maatwerk', 'Project'],
